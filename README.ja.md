...
最初の provider の設計は[マーカートラッキング provider](docs/marker-tracking-provider.ja.md)にまとめてあります。既知サイズの平面 fiducial マーカーの 6-DoF 姿勢を扱うもので、以下の提案のうち**いま作って検証できる部分**です。SLAM ではなく、後続の system がそのまま使える境界を公開します。
